...
const DEFAULT_NETWORK_STATIONS = Object.freeze([
  ...
  {
    id: "three-stooges-new-apants",
    title: "Sing a Song of Six Pants",
    source: "Internet Archive",
    provider: "Internet Archive",
    categoryId: "classic-comedy",
    category: "Classic Comedy",
    badge: "MOVIE",
    schedule: "On Demand",
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewApants2.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Classic Three Stooges comedy short.",
    attribution: "Internet Archive collection.",
    fallbackVideoId: "",
    fallbackUrl: "https://archive.org/download/3stooges/3stooges_NewApants2_512kb.mp4",
    enabled: true,
    rightsStatus: "PUBLIC_DOMAIN_REVIEW_REQUIRED",
    healthStatus: "PENDING_VALIDATION",
  },
  {
    id: "three-stooges-new-apants-512",
    title: "Sing a Song of Six Pants — 512kb",
    source: "Internet Archive",
    provider: "Internet Archive",
    categoryId: "classic-comedy",
    category: "Classic Comedy",
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewApants2_512kb.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Lower-bandwidth MP4 edition.",
    attribution: "Internet Archive collection.",
    fallbackVideoId: "",
    fallbackUrl: "",
    enabled: true,
  ...
  },
  {
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewDisorder2.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Classic Three Stooges comedy short.",
    attribution: "Internet Archive collection.",
    fallbackVideoId: "",
    fallbackUrl: "https://archive.org/download/3stooges/3stooges_NewDisorder2_512kb.mp4",
    enabled: true,
    rightsStatus: "PUBLIC_DOMAIN_REVIEW_REQUIRED",
    healthStatus: "PENDING_VALIDATION",
  },
  {
    id: "three-stooges-new-disorder-512",
    title: "Disorder in the Court — 512kb",
    source: "Internet Archive",
    provider: "Internet Archive",
    categoryId: "classic-comedy",
    category: "Classic Comedy",
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewDisorder2_512kb.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Lower-bandwidth MP4 edition.",
    attribution: "Internet Archive collection.",
  ...
  },
  {
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewGroom.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Classic Three Stooges comedy short.",
    attribution: "Internet Archive collection.",
    fallbackVideoId: "",
    fallbackUrl: "https://archive.org/download/3stooges/3stooges_NewGroom_512kb.mp4",
    enabled: true,
    rightsStatus: "PUBLIC_DOMAIN_REVIEW_REQUIRED",
    healthStatus: "PENDING_VALIDATION",
  },
  {
    id: "three-stooges-new-groom-512",
    title: "Brideless Groom — 512kb",
    source: "Internet Archive",
    provider: "Internet Archive",
    categoryId: "classic-comedy",
    category: "Classic Comedy",
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewGroom_512kb.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Lower-bandwidth MP4 edition.",
    attribution: "Internet Archive collection.",
  ...
  },
  {
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewMalice1.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Classic Three Stooges comedy short.",
    attribution: "Internet Archive collection.",
    fallbackVideoId: "",
    fallbackUrl: "https://archive.org/download/3stooges/3stooges_NewMalice1_512kb.mp4",
    enabled: true,
    rightsStatus: "PUBLIC_DOMAIN_REVIEW_REQUIRED",
    healthStatus: "PENDING_VALIDATION",
  },
  {
    id: "three-stooges-new-malice-512",
    title: "Malice in the Palace — 512kb",
    source: "Internet Archive",
    provider: "Internet Archive",
    categoryId: "classic-comedy",
    category: "Classic Comedy",
    ...
    videoId: "",
    sourceType: "DIRECT_MP4",
    sourceUrl: "https://archive.org/download/3stooges/3stooges_NewMalice1_512kb.mp4",
    embedUrl: "",
    thumbnail: "https://archive.org/download/3stooges/__ia_thumb.jpg",
    description: "Lower-bandwidth MP4 edition.",
    attribution: "Internet Archive collection.",
